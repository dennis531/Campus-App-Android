...
import de.tum.`in`.tumcampusapp.api.auth.exception.NoAccessTokenException
import de.tum.`in`.tumcampusapp.api.auth.exception.NoAccessTokenSecretException
import de.tum.`in`.tumcampusapp.config.OAuthSignatureMethod
