...
import de.uos.campusapp.utils.Const.ADD_GEOFENCE_EXTRA
import de.uos.campusapp.utils.Const.GEOFENCING_SERVICE_JOB_ID
...
class GeofencingRegistrationService : JobIntentService() {
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        val geofencePendingIntent = PendingIntent.getBroadcast(
                this, 0, geofenceIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
