...
class OpenHoursHelper(private val context: Context) {
    ...
    fun getHoursByIdAsString(id: String, date: DateTime): String {
        ...
        // Simple solution, as the format of the opening hours is not known. The awaited formatting below is to specific.
        return context.getString(R.string.opening_hours) + ": " + result
