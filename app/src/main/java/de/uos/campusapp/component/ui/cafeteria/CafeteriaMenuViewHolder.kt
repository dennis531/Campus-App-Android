...
import de.uos.campusapp.component.ui.cafeteria.details.CafeteriaMenusAdapter
import de.uos.campusapp.component.ui.cafeteria.details.OpenHoursHelper
...
class CafeteriaMenuViewHolder(
    ...
    fun bind(cafeteria: CafeteriaWithMenus) = with(itemView) {
        ...
        val openingHours = openHoursHelper.getHoursByIdAsString(cafeteria.id)
