...
class TransportationWidget : AppWidgetProvider() {
    ...
    private fun updateAppWidget(
        ...
        val pendingReloadIntent = PendingIntent.getBroadcast(
                context, appWidgetId, reloadIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
    ...
    companion object {
        ...
        private const val BROADCAST_RELOAD_ALL_ALARM = "de.uos.campusapp.intent.action.BROADCAST_TRANSPORTATION_WIDGET_RELOAD_ALL_ALARM"
        private const val BROADCAST_RELOAD_ALL = "de.uos.campusapp.intent.action.BROADCAST_TRANSPORTATION_WIDGET_RELOAD_ALL" // TODO: Rename
        internal const val TRANSPORTATION_WIDGET_FORCE_RELOAD = "de.uos.campusapp.intent.action.TRANSPORTATION_WIDGET_FORCE_RELOAD"
