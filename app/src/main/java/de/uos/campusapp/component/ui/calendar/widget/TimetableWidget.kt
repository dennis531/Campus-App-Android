package de.uos.campusapp.component.ui.calendar.widget
...
class TimetableWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        const val BROADCAST_UPDATE_TIMETABLE_WIDGETS = "de.uos.campusapp.intent.action.BROADCAST_UPDATE_TIMETABLE_WIDGETS"
        ...
        private fun updateAppWidget(
            ...
            val pendingCalendarIntent = PendingIntent.getActivity(
                    context, appWidgetId, calendarIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
            ...
            val eventPendingIntent = PendingIntent.getActivity(
                    context, appWidgetId, eventIntent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
